        ...
        <div className="container mx-auto px-4">
          <motion.div {...fadeUp} className="max-w-3xl mx-auto text-center mb-10">
            ...
            <p className="text-muted-foreground">
              From our founders to our team, we&apos;ve designed, built, and shipped the kinds of systems most firms only consult on. Across industries, this software runs internally and externally — and has saved clients hundreds of thousands in costs annually.
            </p>
          </motion.div>
