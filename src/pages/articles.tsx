      ...
      <section className="bg-gradient-to-br from-[#001d3d] via-primary to-[#003566] text-white overflow-hidden relative">
        ...
        <div className="container mx-auto px-4 py-20 md:py-28 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl mx-auto text-center">
            <p className="text-sm font-semibold text-cyan-300 uppercase tracking-wider mb-4">Articles</p>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">Insights on Leadership &amp; Building</h1>
            <p className="text-lg text-white/80 leading-relaxed">
              Essays by Jeffrey T. Furtado on leadership, operations, mentorship, and building things that last — drawn from a career as an operator, founder, and investor.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-muted/50">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid md:grid-cols-2 gap-6">
            {rest.map((post, i) => (
              <motion.div key={post.id} {...staggerChild((i % 8) * 0.06)}>
