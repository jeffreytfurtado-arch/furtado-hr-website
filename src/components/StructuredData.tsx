...
const PERSON_SCHEMA = {
  ...
  description: 'Jeffrey T. Furtado — also known as Jeffrey Furtado or Jeff Furtado — is an innovative corporate executive, operator, builder, and execution specialist with a career spanning Gaming, Fintech, SaaS, HR Technology, Financial Services, and Real Estate. He has architected revenue growth, modernized and scaled operations, deployed technology, and built and led global teams of over 300 people, leading organizations to profitable, strategic exits. He has held the most senior leadership roles — Chief Executive Officer, Chief Operating Officer, Chief Customer Officer, Chief Revenue Officer, and Chief Marketing Officer. COO & Executive Producer at Big Viking Games and Managing Partner at PreciseHR. Previously served as COO and CRO at Mortgage Automator, playing a central operating role in the company\'s $110 million private equity exit with BVP Forge, structured as a majority recapitalization. Founded and scaled DooLeeNoted, a global resourcing and professional collaboration platform sold to a European acquirer in 2016 for a mid-seven figure amount; helped scale the fintech Progressa through its $84 million Series B and pre-IPO financing; and led CCi through a transaction reported at approximately $32 million. Founder of FurtadoFirm. Participates in the GLG and Guidepoint expert networks.',
