...
const PERSON_SCHEMA = {
  ...
  description: 'Jeffrey T. Furtado is a Canadian executive, operator, entrepreneur and strategic investor. He currently serves as Chief Operating Officer and Executive Producer at Big Viking Games and as Managing Partner at PreciseHR. Previously, he served as Chief Operating Officer and Chief Revenue Officer at Mortgage Automator, where he played a central operating role in the company\'s $110 million private equity exit with BVP Forge, structured as a majority recapitalization. He founded and sold DooLeeNoted to a European acquirer in 2016, helped scale Progressa through its $84 million equity and loan funding round and pre-IPO preparations, and served as Vice President, Sales, Operations and Shared Services at Consumer Centre Inc. through its $24 million exit. He also founded FurtadoFirm and participates in the GLG and Guidepoint expert networks.',
